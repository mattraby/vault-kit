...
A portable [Open Knowledge Format](../../wiki/topic-one/domain/example-concept.md) bundle — a directory of
...
- [Open Knowledge Format (OKF)](../../wiki/topic-one/domain/example-concept.md)
- [Source: How the Open Knowledge Format can improve data sharing](../../sources/topic-one/example-source.md)
